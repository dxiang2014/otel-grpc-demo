...
# Simple Gauge Metric (No scope or nested structure)
metric = Metric(
...
# Simple ResourceMetrics with just service name attribute
resource_metrics = ResourceMetrics(
    ...
    scope_metrics=[ScopeMetrics(metrics=[metric])]  # Correct field for nested metrics
)
